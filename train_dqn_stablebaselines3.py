...
def main():
    ...
    eval_callback = CustomEvalCallback(env, eval_freq=10000, log_path="./logs/")
    ...
    model.save("checkpoints/ppo/ppo_sb3_end2end_5000")
    env.close()
    ...
    with open("ppo_modular_5000_last_execution.txt", "w") as f:
